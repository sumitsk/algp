...
def get_args():
    ...
    # gp model 
    parser.add_argument('--lr', default=.1, type=float, help='learning rate of gpytorch model')
    ...
    parser.add_argument('--phenotype', default='plant_width', help='target feature')
    ...
    parser.add_argument('--num_samples_per_batch', default=4, type=int, help='number of samples collected by sensor in each batch')
    ...
    parser.add_argument('--sensor_std', default=.5, type=float, help='standard deviation of sensor measurements')
